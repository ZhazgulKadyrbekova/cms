...
class TargetControllerTest {
    ...
    @Test
    void addTarget() throws Exception{
        TargetDTO targetDTO = new TargetDTO("Blah-blah-blah...");
        String jsonRequest = mapper.writeValueAsString(targetDTO);
        MvcResult result = mvc
                .perform(post("/target")
                        .content(jsonRequest)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    @Test
    void deleteTargetByID() throws Exception {
        MvcResult result = mvc
                .perform(delete("/target/{id}", 3)
                        .contentType(MediaType.APPLICATION_JSON))
