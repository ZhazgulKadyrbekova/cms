...
//
//          bishPositionRepo.save(new BishPosition("Маркетолог"));
//          bishPositionRepo.save(new BishPosition("Менеджер"));
//          bishPositionRepo.save(new BishPosition("Ментор"));
//          bishPositionRepo.save(new BishPosition("Преподаватель"));
//
//          oshPositionRepo.save(new OshPosition("Маркетолог"));
//          oshPositionRepo.save(new OshPosition("Менеджер"));
//          oshPositionRepo.save(new OshPosition("Ментор"));
//          oshPositionRepo.save(new OshPosition("Преподаватель"));
//
//          bishMethodRepo.save(new BishMethod("Оптима Bank"));
