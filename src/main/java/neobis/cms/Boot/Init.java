...
public class Init implements CommandLineRunner {
    ...
    public Init(UserService service, RoleRepo roleRepo, BishStatusesRepo bishStatusesRepo, OshStatusesRepo oshStatusesRepo, BishLeavingReasonRepo bishLeavingReasonRepo, OshLeavingReasonRepo oshLeavingReasonRepo, BishPositionRepo bishPositionRepo, OshPositionRepo oshPositionRepo) {
